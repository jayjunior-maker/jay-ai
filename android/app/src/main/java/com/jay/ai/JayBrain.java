...
public class JayBrain {
    ...
    public String think(String input) {
        ...
        if (containsAny(text,"what did i tell you","what did i ask","unakumbuka nini","who am i","who i am")) { String memory=database.getMemory("last_request"); return memory==null?"Sir, I don't have your name saved yet. Tell me: remember my name is ...":"Sir, the saved memory says: "+memory; }
