...
/** Intent-specific device tools. Each method returns only the requested category. */
public final class JayDeviceTools {
    ...
    public static String getNetwork(Context context) {
        try {
            ...
            return "Network information unavailable, Sir.";
        }
    }
    ...
    public static String getBattery(Context context) {
        try {
            ...
            return "Battery: " + level + "%\nCharging: " + (Build.VERSION.SDK_INT >= 23 && bm.isCharging());
        } catch (Exception e) {
