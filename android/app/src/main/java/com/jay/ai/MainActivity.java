...
public class MainActivity extends Activity implements TextToSpeech.OnInitListener {
    ...
    private void buildJayInterface(){
        ...
        LinearLayout inputRow=new LinearLayout(this);inputRow.setGravity(Gravity.CENTER_VERTICAL);inputRow.setPadding(14,4,7,4);inputRow.setBackground(panel(BLUE,Color.rgb(5,17,37),45));inputBox=new EditText(this);inputBox.setHint("Ask Jay anything...");inputBox.setHintTextColor(Color.rgb(135,155,185));inputBox.setTextColor(Color.WHITE);inputBox.setTextSize(18);inputBox.setSingleLine(true);inputBox.setOnEditorActionListener((v,a,e)->{processMessage(inputBox.getText().toString());inputBox.setText("");return true;});inputRow.addView(inputBox,new LinearLayout.LayoutParams(0,66,1));Button mic=makeAction("🎙");mic.setTextSize(23);mic.setBackground(panel(0,Color.rgb(8,25,49),20));mic.setOnClickListener(v->startListening());inputRow.addView(mic,new LinearLayout.LayoutParams(62,60));add(content,inputRow,8,0,8,14);
